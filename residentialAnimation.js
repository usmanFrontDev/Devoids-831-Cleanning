...
(function initSection2() {
  ...
  const leftImg  = trigger.querySelector(".section2LeftImage");
  ...
  // b. image clip from left (not circle)
  if (leftImg) {
    gsap.set(leftImg, { clipPath: "inset(0 100% 0 0)" });
    gsap.to(leftImg, {
      clipPath: "inset(0 0% 0 0)",
      duration: 1.2,
      ease: EASE,
...
(function initSection3() {
  ...
  // a. image scale+opacity 0 from bottom (transform origin bottom)
  if (leftImg) {
